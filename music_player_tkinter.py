...
def play_song():
    filename = filedialog.askopenfilename(initialdir="C:\\Users\\korisnik\\Desktop\\python projects",title="Please select file.")
...
def reduce_volume():
    try:
        ...
        print(e)
        song_title_label.config(fg="red",text="Track hasn't selected yet.")
...
Label(master,text="Please select a music track you would like to play!",font=("Calibri",15),fg="blue").grid(sticky="N",row=1)
